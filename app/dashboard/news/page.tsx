  ...
  const newsItems = [
    {
      ...
      description:
        "Technology sector leads gains with major indices posting strong performance.",
      category: "Market",
      time: "2 hours ago",
      image: "📈",
    },
    {
      ...
      description:
        "Three major companies announce plans for public listing in Q2.",
      category: "IPO",
      time: "5 hours ago",
      image: "🚀",
    },
    {
      ...
      description:
        "Central bank maintains repo rate, focuses on inflation control.",
      category: "Policy",
      time: "1 day ago",
      image: "🏦",
    },
